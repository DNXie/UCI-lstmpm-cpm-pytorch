...
state_dict = torch.load('/home/danningx/code/8-15/checkpoint/penn_lstm_pm_19')
...
def history_dict_init(path=None):
    if path is None:
        history_dict={}
...
history_dict = history_dict_init(path='/home/danningx/code/8-15/train_history.json')
save_json_path = "/home/danningx/code/8-15/train_history2.json"
...
for epoch in range(20,nb_epochs):
